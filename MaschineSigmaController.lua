...
function MaschineSigmaController:createPages()
    ...
    local MaschineShared = "Scripts/Maschine/Shared/Pages/" -- hack
    ...
    Pages:register(NI.HW.PAGE_FILE, Sigma .. "FilePageStudio", "FilePageStudio", true) -- hack
    Pages:register(NI.HW.PAGE_SAVE_AS, MaschineShared .. "SaveAsPage", "SaveAsPage", true) -- hack
